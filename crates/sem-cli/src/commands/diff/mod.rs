...
use crate::formatters::{
    json::format_json, markdown::format_markdown, nice::format_nice, plain::format_plain,
...
fn parse_output_format(value: &str) -> OutputFormat {
    match value {
        ...
        "nice" => OutputFormat::Nice,
        _ => {
            eprintln!(
                "\x1b[31mError: invalid output format '{value}'. Expected terminal, plain, json, markdown, md, or nice.\x1b[0m"
            );
            process::exit(1);
        }
    }
